                ...
                <div className="d-flex order-lg-2 align-items-center ms-auto">
                  ...
                  <Dropdown className=" main-header-notification">
                    ...
                    >
                      ...
                      <span className="badge bg-danger nav-link-badge">0</span>
                    </Dropdown.Toggle>
                  ...
                  <Dropdown className="main-profile-menu">
                    ...
                    <Dropdown.Menu style={{ margin: "0px" }}>
                      ...
                      <Dropdown.Item
                        onClick={() => {
                          localStorage.removeItem("akkxX877Kl");
                          localStorage.removeItem("o0pxFFgkOo");
                          localStorage.removeItem("ppL86wS9qq");
                          localStorage.removeItem("jjQTkm78m0");
                          localStorage.removeItem("oqJSDS97QL");
